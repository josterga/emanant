...
function tok(dark: boolean) {
  return dark ? {
    ...
    subduedFg:      'rgba(255,255,255,0.52)',
    ...
    markFill:       '#1a1916',
    dialTick:       'rgba(255,255,255,0.28)',
